...
public class PhysicsSprite extends Drawable implements Updateable {
    ...
    private final SpriteDrawable mDrawable;
    ...
    public Vector2 position() {
        return mBody.getTransform().getPosition()
                .scl(GameServices.PIXELS_PER_METER);
    }
    ...
    public void setPosition(float x, float y) {
        mBody.setTransform(new Vector2(x, y)
                .scl((float) (1.0 / GameServices.PIXELS_PER_METER)), 0);
    }
